...
const Temperature: React.FunctionComponent<{
    temperature: LiveWeatherData<DetailedRealtimeData["tempOut"]>;
    ...
    return (
        <Tooltip title={tooltip} variant="outlined">
            <Card
                className={`temperature live-component ${
                    temperature.val === null ? "no-data" : ""
                }`}
            >
                <Typography textAlign={"left"} noWrap>
                    <Typography
                        ...
                        noWrap
                        className="value"
                        textColor={colorizeTemperature(temperature.val)}
                    >
                        <TextTransition
                    ...
                    <Typography
                        ...
                        fontWeight={100}
                    >
                        {temperature.val === null ? "" : unit}
                    </Typography>
                </Typography>
                <Typography startDecorator={<DeviceThermostatIcon />}>
                    {title}
                </Typography>
            </Card>
        </Tooltip>
