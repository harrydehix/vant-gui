...
const Forecast: React.FunctionComponent<{
    forecast: LiveWeatherData<DetailedRealtimeData["forecast"]>;
    ...
    function forecastIcon() {
        switch (forecast.val) {
            ...
            case "Partly Cloudy":
                return day ? (
                    <BSCloudSunFill style={style} />
                ) : (
                    <BSCloudMoonFill style={style} />
                );
            case "Mostly Cloudy":
                return <BSCloudsFill style={style} />;
            case "Mostly Cloudy, Rain within 12 hours":
                return <BSCloudRainFill style={style} />;
            case "Mostly Cloudy, Snow within 12 hours":
                return <BSCloudSnowFill style={style} />;
            case "Mostly Cloudy, Rain or Snow within 12 hours":
                return <BSCloudHailFill style={style} />;
            case "Partly Cloudy, Rain within 12 hours":
                return <BSCloudRainFill style={style} />;
            case "Partly Cloudy, Rain or Snow within 12 hours":
                return <BSCloudHailFill style={style} />;
            case "Partly Cloudy, Snow within 12 hours":
                return <BSCloudSnowFill style={style} />;
            case "Mostly Clear":
                return day ? (
                    <BSSunFill style={style} />
                ) : (
                    <BSMoonStarsFill style={style} />
                );
            default:
                return "";
        }
    ...
    function forecastVideo() {
        switch (forecast.val) {
            case "Mostly Clear":
                return day
                    ? "partly-cloudy-day-loop.mp4"
                    : "partly-cloudy-night-loop.mp4";
            case "Partly Cloudy":
                return day
                    ? "partly-cloudy-day-loop.mp4"
                    : "partly-cloudy-night-loop.mp4";
            case "Mostly Cloudy":
                return day
                    ? "mostly-cloudy-loop.mp4"
                    : "mostly-cloudy-night-loop.mpg";
            case "Mostly Cloudy, Rain within 12 hours":
                return "rain-loop.mp4";
            case "Mostly Cloudy, Snow within 12 hours":
                return "snow-loop.mp4";
            case "Mostly Cloudy, Rain or Snow within 12 hours":
                return "snowrain-loop.mp4";
            case "Partly Cloudy, Rain within 12 hours":
                return "rain-sun-loop.mp4";
            case "Partly Cloudy, Rain or Snow within 12 hours":
                return "snowrain-loop.mp4";
            case "Partly Cloudy, Snow within 12 hours":
                return "snow-sun-loop.mp4";
            default:
                return "";
        }
    }
    ...
    return (
        <Tooltip title={tooltip} variant="outlined">
            <Card
                className={`forecast live-component ${
                    forecast.val === null ? "no-data" : ""
                }`}
            >
                <CardBackgroundVideo
                    opacity={0.5}
                ...
                <CardContent>
                    ...
                    <Typography startDecorator={<QueryStatsIcon />}>
                        {title}
                    </Typography>
                </CardContent>
            </Card>
